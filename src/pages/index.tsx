  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to fresh, your personal nutrition companion. Create custom meal plans, receive dietary guidance, and explore nutritional courses. Engage with specialists and embrace a healthier lifestyle."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to fresh, your personal nutrition companion. Create custom meal plans, receive dietary guidance, and explore nutritional courses. Engage with specialists and embrace a healthier lifestyle.`}
            </Text>
            <Box
